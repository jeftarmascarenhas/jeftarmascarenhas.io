    ...
    <Layout>
      ...
      <Box className="my-4">
        <BoxHeader>
          ...
          <C.SubTitle>
            {intl.formatMessage({ id: 'policies.description' })}
          </C.SubTitle>
          <hr />
        </BoxHeader>
        <BoxBody>
          ...
          <p>
            ...
            seu browser, etc. Esta função é geralmente utilizada para
            geotargeting (mostrar publicidade de Lisboa apenas aos leitores
            oriundos de Lisboa por ex.) ou apresentar publicidade direcionada a
            um tipo de utilizador (como mostrar publicidade de restaurante a um
